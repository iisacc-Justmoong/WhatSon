...
namespace WhatSon::Permissions
{
    ...
    {
        WhatSon::Debug::trace(
            QStringLiteral("permissions.stub.photo"),
    ...
    {
        WhatSon::Debug::trace(
            QStringLiteral("permissions.stub.reminders"),
            QStringLiteral("request"),
            QStringLiteral("hasCompletion=%1")
            .arg(completion ? QStringLiteral("1") : QStringLiteral("0")));
        if (completion)
    ...
    {
        WhatSon::Debug::trace(
            QStringLiteral("permissions.stub.accessibility"),
            QStringLiteral("request"),
            QStringLiteral("hasCompletion=%1")
            .arg(completion ? QStringLiteral("1") : QStringLiteral("0")));
        if (completion)
    ...
    {
        WhatSon::Debug::trace(
            QStringLiteral("permissions.stub.localNetwork"),
            QStringLiteral("request"),
            QStringLiteral("hasCompletion=%1")
            .arg(completion ? QStringLiteral("1") : QStringLiteral("0")));
        if (completion)
    ...
    {
        WhatSon::Debug::trace(
            QStringLiteral("permissions.stub.fullDisk"),
            QStringLiteral("request"),
            QStringLiteral("hasCompletion=%1")
            .arg(completion ? QStringLiteral("1") : QStringLiteral("0")));
        if (completion)
