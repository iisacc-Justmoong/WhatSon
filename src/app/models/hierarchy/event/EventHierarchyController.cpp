...
#include "app/models/hierarchy/event/WhatSonEventHierarchyParser.hpp"
#include "app/models/hierarchy/event/WhatSonEventHierarchyStore.hpp"
#include "app/models/hierarchy/WhatSonHierarchyTreeItemSupport.hpp"
#include "app/models/hierarchy/event/EventHierarchyControllerSupport.hpp"
...
namespace
{
    constexpr auto kScope = "event.controller";
    const QString kKeyPrefix = QStringLiteral("event");
}

EventHierarchyController::EventHierarchyController(QObject* parent)
...
int EventHierarchyController::selectedIndex() const noexcept
{
    return m_selectedIndex;
}

int EventHierarchyController::itemCount() const noexcept
{
    return m_itemCount;
}

bool EventHierarchyController::loadSucceeded() const noexcept
{
    return m_loadSucceeded;
}

QString EventHierarchyController::lastLoadError() const
{
    return m_lastLoadError;
}

void EventHierarchyController::setSelectedIndex(int index)
{
...
void EventHierarchyController::setDepthItems(const QVariantList& depthItems)
{
    WhatSon::Debug::traceSelf(this,
                              QString::fromLatin1(kScope),
...
QVariantList EventHierarchyController::hierarchyModel() const
{
    return depthItems();
}

QVariantList EventHierarchyController::depthItems() const
{
    return WhatSon::Hierarchy::NamedStringSupport::lvrsDepthItems(m_items, kKeyPrefix);
}

QString EventHierarchyController::itemLabel(int index) const
{
...
bool EventHierarchyController::canRenameItem(int index) const
{
    if (index < 0 || index >= m_items.size())
    {
        return false;
...
bool EventHierarchyController::renameItem(int index, const QString& displayName)
{
    WhatSon::Debug::traceSelf(this,
                              QString::fromLatin1(kScope),
...
void EventHierarchyController::deleteSelectedFolder()
{
...
void EventHierarchyController::setEventNames(QStringList eventNames)
{
    WhatSon::Debug::traceSelf(this,
                              QString::fromLatin1(kScope),
...
QStringList EventHierarchyController::eventNames() const
{
    return m_eventNames;
}

bool EventHierarchyController::renameEnabled() const noexcept
{
    return true;
}

bool EventHierarchyController::createFolderEnabled() const noexcept
{
    return false;
}

bool EventHierarchyController::deleteFolderEnabled() const noexcept
{
    return false;
}

bool EventHierarchyController::loadFromWshub(const QString& wshubPath, QString* errorMessage)
{
    WhatSon::Debug::traceSelf(this,
                              QString::fromLatin1(kScope),
...
void EventHierarchyController::applyRuntimeSnapshot(
...
void EventHierarchyController::requestControllerHook()
{
    if (m_eventFilePath.trimmed().isEmpty())
    {
...
bool EventHierarchyController::reloadFromEventFilePath(QString* errorMessage)
{
...
void EventHierarchyController::updateItemCount()
{
...
void EventHierarchyController::updateLoadState(bool succeeded, QString errorMessage)
{
...
void EventHierarchyController::syncDomainStoreFromItems()
{
