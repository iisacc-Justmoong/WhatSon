...
#include "app/models/hierarchy/resources/ResourcesHierarchyControllerSupport.hpp"
...
namespace
{
    constexpr auto kScope = "resources.controller";
...
ResourcesHierarchyController::ResourcesHierarchyController(QObject* parent)
...
ResourcesListModel* ResourcesHierarchyController::noteListModel() noexcept
{
    return &m_noteListModel;
}

int ResourcesHierarchyController::selectedIndex() const noexcept
{
    return m_selectedIndex;
}

int ResourcesHierarchyController::itemCount() const noexcept
{
    return m_itemCount;
}

bool ResourcesHierarchyController::loadSucceeded() const noexcept
{
    return m_loadSucceeded;
}

QString ResourcesHierarchyController::lastLoadError() const
{
    return m_lastLoadError;
}

void ResourcesHierarchyController::setSelectedIndex(int index)
{
...
void ResourcesHierarchyController::setDepthItems(const QVariantList& depthItems)
{
    WhatSon::Debug::traceSelf(this,
                              QString::fromLatin1(kScope),
...
QVariantList ResourcesHierarchyController::hierarchyModel() const
{
    return depthItems();
}

QVariantList ResourcesHierarchyController::depthItems() const
{
...
QString ResourcesHierarchyController::itemLabel(int index) const
{
...
bool ResourcesHierarchyController::canRenameItem(int index) const
{
    Q_UNUSED(index);
    return false;
}

bool ResourcesHierarchyController::renameItem(int index, const QString& displayName)
{
    WhatSon::Debug::traceSelf(this,
                              QString::fromLatin1(kScope),
...
void ResourcesHierarchyController::deleteSelectedFolder()
{
...
bool ResourcesHierarchyController::deleteNoteById(const QString& noteId)
{
...
bool ResourcesHierarchyController::deleteNotesByIds(const QVariantList& noteIds)
{
...
QString ResourcesHierarchyController::noteDirectoryPathForNoteId(const QString& noteId) const
{
    const QString normalizedNoteId = WhatSon::Resources::normalizePath(noteId.trimmed());
    if (normalizedNoteId.isEmpty())
    {
...
void ResourcesHierarchyController::setResourcePaths(QStringList resourcePaths)
{
    WhatSon::Debug::traceSelf(this,
                              QString::fromLatin1(kScope),
...
QStringList ResourcesHierarchyController::resourcePaths() const
{
    return m_resourcePaths;
}

bool ResourcesHierarchyController::renameEnabled() const noexcept
{
    return false;
}

bool ResourcesHierarchyController::createFolderEnabled() const noexcept
{
    return false;
}

bool ResourcesHierarchyController::deleteFolderEnabled() const noexcept
{
    return false;
}

bool ResourcesHierarchyController::loadFromWshub(const QString& wshubPath, QString* errorMessage)
{
    WhatSon::Debug::traceSelf(this,
                              QString::fromLatin1(kScope),
...
void ResourcesHierarchyController::applyRuntimeSnapshot(
...
void ResourcesHierarchyController::requestControllerHook()
{
...
bool ResourcesHierarchyController::reloadFromResourcesFilePath(QString* errorMessage)
{
...
void ResourcesHierarchyController::updateItemCount()
{
...
void ResourcesHierarchyController::updateLoadState(bool succeeded, QString errorMessage)
{
...
void ResourcesHierarchyController::syncDomainStoreFromItems()
{
    m_resourcePaths = WhatSon::Hierarchy::ResourcesSupport::extractResourcePathsFromItems(m_items);
    m_store.setResourcePaths(m_resourcePaths);
}

void ResourcesHierarchyController::refreshNoteListForSelection()
{
    const ResourcesHierarchyItem* selectedItem = nullptr;
...
void ResourcesHierarchyController::setResourceResolutionBasePaths(QStringList basePaths)
{
