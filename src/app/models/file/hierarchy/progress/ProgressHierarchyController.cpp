...
namespace
{
    constexpr auto kScope = "progress.controller";
...
LibraryNoteListModel* ProgressHierarchyController::noteListModel() noexcept
{
    return &m_noteListModel;
}

int ProgressHierarchyController::selectedIndex() const noexcept
{
    return m_selectedIndex;
}

int ProgressHierarchyController::itemCount() const noexcept
{
    return m_itemCount;
}

int ProgressHierarchyController::noteItemCount() const noexcept
{
    return m_noteItemCount;
}

bool ProgressHierarchyController::loadSucceeded() const noexcept
{
    return m_loadSucceeded;
}

QString ProgressHierarchyController::lastLoadError() const
{
    return m_lastLoadError;
}

void ProgressHierarchyController::setSelectedIndex(int index)
{
...
void ProgressHierarchyController::setDepthItems(const QVariantList& depthItems)
{
    WhatSon::Debug::traceSelf(this,
                              QString::fromLatin1(kScope),
...
QVariantList ProgressHierarchyController::hierarchyModel() const
{
    return depthItems();
}

QVariantList ProgressHierarchyController::depthItems() const
{
...
QString ProgressHierarchyController::itemLabel(int index) const
{
...
bool ProgressHierarchyController::canRenameItem(int index) const
{
    Q_UNUSED(index);
    return false;
}

bool ProgressHierarchyController::renameItem(int index, const QString& displayName)
{
    WhatSon::Debug::traceSelf(this,
                              QString::fromLatin1(kScope),
...
void ProgressHierarchyController::deleteSelectedFolder()
{
    WhatSon::Debug::traceSelf(this,
                              QString::fromLatin1(kScope),
...
void ProgressHierarchyController::setProgressState(int progressValue, QStringList progressStates)
{
    WhatSon::Debug::traceSelf(this,
                              QString::fromLatin1(kScope),
...
int ProgressHierarchyController::progressValue() const noexcept
{
    return m_progressValue;
}

QStringList ProgressHierarchyController::progressStates() const
{
    return m_progressStates;
}

bool ProgressHierarchyController::renameEnabled() const noexcept
{
    return false;
}

bool ProgressHierarchyController::createFolderEnabled() const noexcept
{
    return false;
}

bool ProgressHierarchyController::deleteFolderEnabled() const noexcept
{
    return false;
}
...
void ProgressHierarchyController::applyRuntimeSnapshot(
    int progressValue,
...
void ProgressHierarchyController::requestControllerHook()
{
...
bool ProgressHierarchyController::reloadFromProgressFilePath(QString* errorMessage)
{
...
void ProgressHierarchyController::updateItemCount()
{
...
void ProgressHierarchyController::updateNoteItemCount()
{
...
void ProgressHierarchyController::updateLoadState(bool succeeded, QString errorMessage)
{
...
LibraryNoteListItem ProgressHierarchyController::buildNoteListItem(const LibraryNoteRecord& note) const
{
...
void ProgressHierarchyController::refreshNoteListForSelection()
{
...
bool ProgressHierarchyController::refreshIndexedNotesFromWshub(const QString& wshubPath, QString* errorMessage)
{
...
bool ProgressHierarchyController::refreshIndexedNotesFromProgressFilePath(QString* errorMessage)
{
...
int ProgressHierarchyController::selectedProgressFilterValue() const noexcept
{
...
void ProgressHierarchyController::rebuildItems()
{
...
void ProgressHierarchyController::syncProgressStore()
{
    m_store.setProgressValue(m_progressValue);
    m_store.setProgressStates(m_progressStates);
}

void ProgressHierarchyController::syncProgressStatesFromItems()
{
