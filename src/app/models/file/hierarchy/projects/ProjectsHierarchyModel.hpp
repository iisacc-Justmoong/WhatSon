...
public:
    ...
    explicit ProjectsHierarchyModel(QObject* parent = nullptr);
    ...
    void setItems(QVector<ProjectsHierarchyItem> items);
    const QVector<ProjectsHierarchyItem>& items() const noexcept;
