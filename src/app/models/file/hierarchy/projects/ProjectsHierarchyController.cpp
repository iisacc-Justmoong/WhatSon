...
LibraryNoteListModel* ProjectsHierarchyController::noteListModel() noexcept
{
    return &m_noteListModel;
}

bool ProjectsHierarchyController::supportsHierarchyNodeReorder() const noexcept
{
    return true;
}
...
int ProjectsHierarchyController::itemCount() const noexcept
{
    return m_itemCount;
}

bool ProjectsHierarchyController::loadSucceeded() const noexcept
{
    return m_loadSucceeded;
}

QString ProjectsHierarchyController::lastLoadError() const
{
    return m_lastLoadError;
}

void ProjectsHierarchyController::setSelectedIndex(int index)
{
...
void ProjectsHierarchyController::setDepthItems(const QVariantList& depthItems)
{
    WhatSon::Debug::traceSelf(this,
                              QString::fromLatin1(kScope),
...
QVariantList ProjectsHierarchyController::hierarchyModel() const
{
    return depthItems();
}

QVariantList ProjectsHierarchyController::depthItems() const
{
...
QString ProjectsHierarchyController::itemLabel(int index) const
{
...
bool ProjectsHierarchyController::canRenameItem(int index) const
{
    if (index < 0 || index >= m_items.size())
    {
        return false;
...
bool ProjectsHierarchyController::renameItem(int index, const QString& displayName)
{
    WhatSon::Debug::traceSelf(this,
                              QString::fromLatin1(kScope),
...
void ProjectsHierarchyController::deleteSelectedFolder()
{
...
bool ProjectsHierarchyController::canMoveFolder(int index) const
{
    return isEditableFolderItem(m_items, index);
}

bool ProjectsHierarchyController::canAcceptFolderDropBefore(int sourceIndex, int targetIndex) const
{
...
bool ProjectsHierarchyController::moveFolderBefore(int sourceIndex, int targetIndex)
{
    WhatSon::Debug::traceSelf(this,
                              QString::fromLatin1(kScope),
...
bool ProjectsHierarchyController::moveFolder(int sourceIndex, int targetIndex, bool asChild)
{
    WhatSon::Debug::traceSelf(this,
                              QString::fromLatin1(kScope),
...
bool ProjectsHierarchyController::canMoveFolderToRoot(int sourceIndex) const
{
    return resolveFolderMoveOperation(
        m_items,
        sourceIndex,
...
bool ProjectsHierarchyController::moveFolderToRoot(int sourceIndex)
{
    WhatSon::Debug::traceSelf(this,
                              QString::fromLatin1(kScope),
...
bool ProjectsHierarchyController::applyHierarchyNodes(const QVariantList& hierarchyNodes, const QString& activeItemKey)
{
...
void ProjectsHierarchyController::setProjectNames(QStringList projectNames)
{
    WhatSon::Debug::traceSelf(this,
                              QString::fromLatin1(kScope),
...
QStringList ProjectsHierarchyController::projectNames() const
{
    return m_projectNames;
}

bool ProjectsHierarchyController::renameEnabled() const noexcept
{
    return true;
}

bool ProjectsHierarchyController::createFolderEnabled() const noexcept
{
    return true;
}

bool ProjectsHierarchyController::deleteFolderEnabled() const noexcept
{
...
bool ProjectsHierarchyController::loadFromWshub(const QString& wshubPath, QString* errorMessage)
{
    WhatSon::Debug::traceSelf(this,
                              QString::fromLatin1(kScope),
...
void ProjectsHierarchyController::applyRuntimeSnapshot(
...
void ProjectsHierarchyController::requestControllerHook()
{
    if (m_projectsFilePath.trimmed().isEmpty())
    {
...
void ProjectsHierarchyController::updateItemCount()
{
...
void ProjectsHierarchyController::updateLoadState(bool succeeded, QString errorMessage)
{
...
LibraryNoteListItem ProjectsHierarchyController::buildNoteListItem(const LibraryNoteRecord& note) const
{
...
bool ProjectsHierarchyController::refreshIndexedNotesFromWshub(const QString& wshubPath, QString* errorMessage)
{
...
bool ProjectsHierarchyController::refreshIndexedNotesFromProjectsFilePath(QString* errorMessage)
{
