...
namespace
{
    ...
    bool hasNoteDirectoryResolver(const QObject* sourceController)
    {
...
QObject* DetailCurrentNoteContextBridge::noteDirectorySourceController() const noexcept
{
    return m_noteDirectorySourceController.data();
}

void DetailCurrentNoteContextBridge::setNoteDirectorySourceController(QObject* sourceController)
{
    if (sourceController != nullptr
        && !WhatSon::Policy::verifyMutableDependencyAllowed(
            WhatSon::Policy::Layer::View,
            WhatSon::Policy::Layer::Controller,
            QStringLiteral("DetailCurrentNoteContextBridge::setNoteDirectorySourceController")))
    {
        return;
    }
    ...
    if (m_noteDirectorySourceController == sourceController)
    {
        return;
    }
    m_noteDirectorySourceController = sourceController;
    emit noteDirectorySourceControllerChanged();
    refreshContext();
}
...
void DetailCurrentNoteContextBridge::refreshContext()
{
    ...
    else
    {
        ...
        if (!directoryResolved && hasNoteDirectoryResolver(m_noteDirectorySourceController.data()) && !nextNoteId.isEmpty())
        {
            directoryResolved = QMetaObject::invokeMethod(
                m_noteDirectorySourceController,
