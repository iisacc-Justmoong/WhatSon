...
YearCalendarController::YearCalendarController(QObject* parent)
    : QObject(parent)
...
int YearCalendarController::displayedYear() const noexcept
{
    return m_displayedYear;
}

YearCalendarController::CalendarSystem YearCalendarController::calendarSystem() const noexcept
{
    return m_calendarSystem;
}

QString YearCalendarController::calendarSystemName() const
{
    return calendarSystemLabel(m_calendarSystem);
}

QStringList YearCalendarController::weekdayLabels() const
{
    return m_weekdayLabels;
}

QVariantList YearCalendarController::monthModels() const
{
    return m_monthModels;
}

QVariantList YearCalendarController::calendarSystemOptions() const
{
    return {
        QVariantMap{
...
void YearCalendarController::setCalendarBoardStore(ICalendarBoardStore* calendarBoardStore)
{
    if (calendarBoardStore != nullptr
        && !WhatSon::Policy::verifyMutableDependencyAllowed(
            ...
            QStringLiteral("YearCalendarController::setCalendarBoardStore")))
    {
        return;
    }
...
void YearCalendarController::setDisplayedYear(int year)
{
...
void YearCalendarController::setCalendarSystemByEnum(CalendarSystem system)
{
...
void YearCalendarController::setCalendarSystemByValue(int value)
{
    switch (value)
    {
...
void YearCalendarController::shiftYear(int delta)
{
    if (delta == 0)
    {
        return;
...
void YearCalendarController::focusToday()
{
...
void YearCalendarController::requestYearView(const QString& reason)
{
...
bool YearCalendarController::addEvent(
...
bool YearCalendarController::addTask(
    const QString& dateIso,
    const QString& timeText,
    const QString& title,
    const QString& detail)
...
QVariantList YearCalendarController::entriesForDate(const QString& dateIso) const
{
    if (!m_calendarBoardStore)
    {
        return {};
...
bool YearCalendarController::removeEntry(const QString& entryId)
{
    if (!m_calendarBoardStore)
    {
        return false;
...
bool YearCalendarController::setTaskCompleted(const QString& entryId, bool completed)
{
    if (!m_calendarBoardStore)
    {
        return false;
...
void YearCalendarController::rebuildYearModel()
{
    const QCalendar calendar = resolveCalendarSystem();
...
QCalendar YearCalendarController::resolveCalendarSystem() const
{
...
QString YearCalendarController::calendarSystemLabel(CalendarSystem system)
{
    switch (system)
    {
    case Gregorian:
