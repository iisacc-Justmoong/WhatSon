...
namespace
{
    ...
    QString renderInlineTaggedTextFragmentToHtmlImpl(
    ...
    QString renderResourceEditorBlockToHtml(const int)
    {
...
namespace WhatSon::ContentsTextFormatRendererInternal
{
    QString renderInlineTaggedTextFragmentToHtml(
        ...
        const LiteralRenderMode renderMode)
    {
        return renderInlineTaggedTextFragmentToHtmlImpl(sourceText, renderMode);
    }

    QString renderInlineStyleEditingSurfaceHtml(const QString& sourceText)
    {
        return renderInlineStyleEditingSurfaceHtmlImpl(sourceText);
    }
}
