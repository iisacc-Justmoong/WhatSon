...
class ContentsDisplayDocumentSourceResolver : public QObject
{
    ...
    Q_PROPERTY(
        QString
            selectedNoteDirectoryPath READ selectedNoteDirectoryPath WRITE setSelectedNoteDirectoryPath
                NOTIFY selectedNoteDirectoryPathChanged)
...
public:
    ...
    void setSelectedNoteDirectoryPath(const QString& value);
    ...
    void setEditorBoundNoteDirectoryPath(const QString& value);
...
private:
    ...
    static QString normalizeNoteDirectoryPath(const QString& value);
