...
ContentsEditorTagMutationBuilder::ContentsEditorTagMutationBuilder(QObject* parent)
    : QObject(parent)
{
}

QString ContentsEditorTagMutationBuilder::normalizedTagName(const QVariant& tagName) const
{
    return normalizeEditorTagName(tagName);
}

QVariantMap ContentsEditorTagMutationBuilder::buildTagInsertionPayload(
...
QVariantMap ContentsEditorTagMutationBuilder::buildWrappedTagInsertionPayload(
    const QVariant& sourceText,
    const int selectionStart,
    const int selectionEnd,
    const QVariant& tagName)
