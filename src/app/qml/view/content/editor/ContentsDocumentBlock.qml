...
FocusScope {
    ...
    ContentsDocumentBlockController {
    ...
    Connections {
        function onSelectionClearRevisionChanged() {
            ...
            const retainedBlockIndex = manager.selectionClearRetainedBlockIndex !== undefined
                    ...
                    : -1
            documentBlockController.clearSelection(retainedBlockIndex === documentBlock.blockIndex)
        }
    ...
    Connections {
        ...
        function onEnterExitRequested(blockData, sourceOffset) {
            documentBlock.enterExitRequested(blockData, sourceOffset)
        }
