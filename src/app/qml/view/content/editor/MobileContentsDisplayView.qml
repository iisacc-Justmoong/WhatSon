...
Item {
    id: contentsView
    objectName: "mobileContentsDisplayView"
    ...
    readonly property string mobileEditorDisplayText: editorProjection.logicalText
    ...
    Component.onCompleted: {
        EditorTrace.trace("mobileDisplayView", "mount", "visible=" + contentsView.visible, contentsView)
    ...
    onVisibleChanged: {
        EditorTrace.trace("mobileDisplayView", "visibleChanged", "visible=" + visible, contentsView)
        if (visible) {
            contentsView.scheduleSelectionModelSync({
                                                       "scheduleReconcile": true,
