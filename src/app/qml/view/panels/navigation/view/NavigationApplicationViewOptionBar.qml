...
LV.HStack {
    ...
    readonly property var panelController: panelControllerRegistry ? panelControllerRegistry.panelController("navigation.view.NavigationApplicationViewOptionBar") : null
