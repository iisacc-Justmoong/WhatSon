...
LV.HStack {
    ...
    readonly property var panelViewModel: panelViewModelRegistry ? panelViewModelRegistry.panelViewModel("navigation.view.NavigationApplicationViewCalendarBar") : null
