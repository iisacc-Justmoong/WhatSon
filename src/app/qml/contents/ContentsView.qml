...
Rectangle {
    ...
    readonly property int defaultActiveLineNumber: LV.Theme.controlHeightMd - LV.Theme.gap5
    ...
    readonly property int defaultLineNumberCount: LV.Theme.controlHeightMd + LV.Theme.gap7
    readonly property int defaultMinimapRowCount: LV.Theme.gap24 + LV.Theme.gap20 + LV.Theme.gap12 + LV.Theme.gap8
    ...
    LV.HStack {
        ...
        Gutter {
            ...
            Layout.preferredWidth: LV.Theme.gap24 + LV.Theme.gap24 + LV.Theme.gap24 + LV.Theme.gap2
        ...
        Minimap {
            ...
            Layout.fillHeight: true
            Layout.preferredWidth: LV.Theme.buttonMinWidth
