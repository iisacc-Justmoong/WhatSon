...
class ResourceDetailPanelViewModel final : public QObject
{
    Q_OBJECT
...
public:
    explicit ResourceDetailPanelViewModel(QObject* parent = nullptr);
    ~ResourceDetailPanelViewModel() override;
