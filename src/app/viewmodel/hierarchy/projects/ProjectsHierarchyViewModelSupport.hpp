...
namespace WhatSon::Hierarchy::ProjectsSupport
{
    ...
    inline ProjectsHierarchyItem parseItemEntry(const QVariant& entry, int fallbackOrdinal,
    ...
    inline QVector<ProjectsHierarchyItem> parseDepthItems(
    ...
    inline QVariantList serializeDepthItems(const QVector<ProjectsHierarchyItem>& items)
    {
    ...
    inline QVector<ProjectsHierarchyItem> buildBucketItems(
    ...
    inline void applyChevronByDepth(QVector<ProjectsHierarchyItem>* items)
    {
        if (items == nullptr)
        {
            return;
    ...
    inline int nextGeneratedFolderSequence(const QVector<ProjectsHierarchyItem>& items)
    {
    ...
    inline bool renameHierarchyItem(QVector<ProjectsHierarchyItem>* items, int index, const QString& displayName)
    {
    ...
    inline bool isBucketHeaderItem(const ProjectsHierarchyItem& item)
    {
    ...
    inline int deleteHierarchySubtree(QVector<ProjectsHierarchyItem>* items, int selectedIndex)
    {
