...
namespace
{
    ...
    QList<PanelBindingExpectation> expectedPanelBindings()
    {
        return {
            ...
            {"view/panels/ListItemsPlaceholder.qml", "ListItemsPlaceholder"},
            ...
            {"view/panels/navigation/NavigationAppControlBar.qml", "navigation.NavigationAppControlBar"},
            {
                "view/panels/navigation/NavigationApplicationContentsBar.qml",
                "navigation.NavigationApplicationContentsBar"
            },
            {"view/panels/navigation/NavigationCalendarBar.qml", "navigation.NavigationCalendarBar"},
            {"view/panels/navigation/NavigationExportBar.qml", "navigation.NavigationExportBar"},
            {"view/panels/navigation/NavigationIconButton.qml", "navigation.NavigationIconButton"},
