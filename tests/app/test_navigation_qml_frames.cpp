...
void NavigationQmlFramesTest::navigationCalendar_mustMountContentSurfaceInline()
{
    ...
    QVERIFY(monthCalendarPage.contains(QStringLiteral("readonly property int monthControlBarHeight: LV.Theme.gap20")));
    QVERIFY(monthCalendarPage.contains(QStringLiteral("readonly property int monthTitleHeight: 44")));
    QVERIFY(monthCalendarPage.contains(QStringLiteral("readonly property int weekdayHeaderHeight: 40")));
    QVERIFY(monthCalendarPage.contains(QStringLiteral("readonly property int visibleWeekRowCount")));
    QVERIFY(monthCalendarPage.contains(QStringLiteral("readonly property int dayNumberHeight: LV.Theme.gap16")));
    QVERIFY(monthCalendarPage.contains(QStringLiteral("readonly property int dayNumberPixelSize: 16")));
    QVERIFY(monthCalendarPage.contains(QStringLiteral("GridLayout {")));
    QVERIFY(monthCalendarPage.contains(QStringLiteral("id: monthControlBand")));
    ...
    QVERIFY(monthCalendarPage.contains(QStringLiteral("anchors.centerIn: parent")));
    QVERIFY(monthCalendarPage.contains(QStringLiteral("anchors.top: weekdayHeaderGrid.bottom")));
    ...
    QVERIFY(monthCalendarPage.contains(QStringLiteral("readonly property int entryCapacity")));
    QVERIFY(monthCalendarPage.contains(QStringLiteral("clip: true")));
    ...
    QVERIFY(monthCalendarPage.contains(QStringLiteral("horizontalAlignment: Text.AlignRight")));
    QVERIFY(monthCalendarPage.contains(QStringLiteral("font.pixelSize: monthCalendarPage.dayNumberPixelSize")));
    QVERIFY(monthCalendarPage.contains(QStringLiteral("text: \"+\" + String(dayCell.dayEntries.length - dayCell.clippedEntryCount)")));
    ...
    QVERIFY(yearCalendarPage.contains(QStringLiteral("readonly property int monthWeekdayPixelSize: Math.max(")));
    QVERIFY(yearCalendarPage.contains(QStringLiteral("readonly property int monthDayPixelSize: Math.max(")));
    ...
    QVERIFY(weekCalendarPage.contains(QStringLiteral("flickableDirection: weekPage.dayColumnScrollEnabled")));
