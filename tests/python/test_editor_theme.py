...
class EditorThemeTests(unittest.TestCase):
    ...
    def test_editor_surface_tokens_match_figma_contract(self) -> None:
        ...
        self.assertIn('readonly property color printPaperTextColor: "#000000"', display_view_text)
        self.assertIn("textColor: contentsView.showPrintEditorLayout", display_view_text)
        self.assertIn("? contentsView.printPaperTextColor", display_view_text)
        self.assertIn(": LV.Theme.bodyColor", display_view_text)
