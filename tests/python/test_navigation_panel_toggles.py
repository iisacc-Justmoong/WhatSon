...
class NavigationPanelToggleTests(unittest.TestCase):
    ...
    def test_calendar_navigation_mounts_inline_content_surface_contract(self) -> None:
        ...
        month_calendar_day_cell_text = (
            REPO_ROOT / "src/app/qml/view/calendar/MonthCalendarDayCell.qml"
        ).read_text(encoding="utf-8")
        calendar_event_cell_text = (
            REPO_ROOT / "src/app/qml/view/calendar/CalendarEventCell.qml"
        ).read_text(encoding="utf-8")
        month_calendar_text = (
        ...
        self.assertIn("readonly property int controlButtonExtent: 20", calendar_today_control_text)
        self.assertIn("readonly property int todayButtonWidth: 50", calendar_today_control_text)
        ...
        self.assertIn("height: calendarTodayControl.controlButtonExtent", calendar_today_control_text)
        self.assertIn("width: calendarTodayControl.todayButtonWidth", calendar_today_control_text)
        ...
        self.assertIn("function entryCardLabel(entryModel)", day_calendar_text)
        self.assertIn("readonly property real slotHeight: Math.max(", day_calendar_text)
        self.assertIn("height: dayTimelineContent.slotHeight", day_calendar_text)
        self.assertNotIn('text: "Entries " + String(dayCalendarPage.dayEntries.length)', day_calendar_text)
        self.assertIn("CalendarEventCell {", day_calendar_text)
        self.assertIn("label: dayCalendarPage.entryCardLabel(slotEntryCard.entryModel)", day_calendar_text)
        ...
        self.assertIn("function buildEntryCellModels(dayEntries)", month_calendar_text)
        self.assertIn("readonly property int maxVisibleEntriesPerCell: 8", month_calendar_text)
        self.assertIn("readonly property int eventBackgroundDefault: 0", month_calendar_text)
        self.assertIn("readonly property int eventBackgroundColored: 1", month_calendar_text)
        self.assertIn("readonly property int monthHeaderHeight: 54", month_calendar_text)
        self.assertIn("readonly property int weekdayHeaderHeight: 39", month_calendar_text)
        self.assertIn("readonly property int headerHorizontalPadding: 8", month_calendar_text)
        self.assertIn("readonly property int weekdayCellHorizontalPadding: 12", month_calendar_text)
        self.assertIn("readonly property int bodyLabelPixelSize: 12", month_calendar_text)
        self.assertIn('readonly property string figmaNodeId: "228:9666"', month_calendar_text)
        self.assertIn("readonly property int visibleWeekRowCount", month_calendar_text)
        self.assertIn("GridLayout {", month_calendar_text)
        self.assertIn("id: monthHeaderBand", month_calendar_text)
        self.assertIn("id: weekdayHeaderBand", month_calendar_text)
        ...
        self.assertIn("anchors.leftMargin: monthCalendarPage.weekdayCellHorizontalPadding", month_calendar_text)
        self.assertIn("font.pixelSize: monthCalendarPage.bodyLabelPixelSize", month_calendar_text)
        self.assertIn("font.weight: Font.Medium", month_calendar_text)
        self.assertIn("anchors.top: weekdayHeaderBand.bottom", month_calendar_text)
        ...
        self.assertIn("MonthCalendarDayCell {", month_calendar_text)
        ...
        self.assertIn("disable: !dayCell.isCurrentMonth", month_calendar_text)
        self.assertIn("entryCells: dayCell.dayEntryCells", month_calendar_text)
        self.assertIn("maxVisibleEntries: monthCalendarPage.maxVisibleEntriesPerCell", month_calendar_text)
        self.assertIn("selected: dayCell.isSelectedDate", month_calendar_text)
        self.assertIn("today: dayCell.isToday", month_calendar_text)
        self.assertNotIn("Flickable {", month_calendar_text)
        self.assertNotIn("ListView {", month_calendar_text)
        self.assertIn("property bool disable: false", month_calendar_day_cell_text)
        self.assertIn("property bool selected: false", month_calendar_day_cell_text)
        self.assertIn("property bool today: false", month_calendar_day_cell_text)
        self.assertIn("property var entryCells: []", month_calendar_day_cell_text)
        self.assertIn("readonly property int dayLabelHeight: 12", month_calendar_day_cell_text)
        self.assertIn("opacity: monthCalendarDayCell.disable ? 0.5 : 1.0", month_calendar_day_cell_text)
        self.assertIn("font.pixelSize: 12", month_calendar_day_cell_text)
        self.assertIn("font.weight: Font.Medium", month_calendar_day_cell_text)
        self.assertIn("CalendarEventCell {", month_calendar_day_cell_text)
        self.assertIn(
        ...
        self.assertIn('property string label: ""', calendar_event_cell_text)
        self.assertIn("readonly property int backgroundDefault: 0", calendar_event_cell_text)
        self.assertIn("readonly property int backgroundColored: 1", calendar_event_cell_text)
        self.assertIn('readonly property string figmaNodeId: "227:9429"', calendar_event_cell_text)
        self.assertIn("property int backgroundType: calendarEventCell.backgroundDefault", calendar_event_cell_text)
        self.assertIn("property color defaultBackgroundColor: LV.Theme.panelBackground08", calendar_event_cell_text)
        self.assertIn("property color coloredBackgroundColor: LV.Theme.primary", calendar_event_cell_text)
        self.assertIn("property int cornerRadius: 4", calendar_event_cell_text)
        self.assertIn(
            "color: calendarEventCell.backgroundType === calendarEventCell.backgroundColored",
            calendar_event_cell_text,
        )
        self.assertIn(": calendarEventCell.defaultBackgroundColor", calendar_event_cell_text)
        self.assertIn("radius: calendarEventCell.cornerRadius", calendar_event_cell_text)
        self.assertIn("font.pixelSize: calendarEventCell.labelPixelSize", calendar_event_cell_text)
        ...
        self.assertIn("CalendarEventCell {", week_calendar_text)
        self.assertIn("function slotBackgroundType(entries)", week_calendar_text)
        self.assertIn("defaultBackgroundColor: LV.Theme.panelBackground11", week_calendar_text)
        self.assertIn("label: weekCalendarPage.slotSummary(dayHourCell.slotEntries)", week_calendar_text)
        ...
        self.assertIn("readonly property real hourRowHeight: Math.max(", week_calendar_text)
        self.assertIn("height: weekPage.hourRowHeight", week_calendar_text)
        self.assertIn("flickableDirection: Flickable.HorizontalFlick", week_calendar_text)
        self.assertIn("interactive: weekPage.dayColumnScrollEnabled", week_calendar_text)
        self.assertNotIn("? Flickable.HorizontalAndVerticalFlick", week_calendar_text)
        self.assertNotIn(": Flickable.VerticalFlick", week_calendar_text)
        self.assertNotIn('text: weekCalendarPage.horizontalDayScrollEnabled ? "Swipe dates" : "Swipe week"', week_calendar_text)
        ...
        self.assertIn("readonly property int monthWeekdayPixelSize: 12", year_calendar_text)
        self.assertIn("readonly property int monthDayPixelSize: 12", year_calendar_text)
        self.assertIn("readonly property color monthTitleColor: LV.Theme.accent", year_calendar_text)
        ...
        self.assertIn("font.weight: Font.Medium", year_calendar_text)
