...
class CliOnboardingTests(unittest.TestCase):
    ...
    def test_app_supports_onboarding_only_launch_mode(self) -> None:
        ...
        self.assertIn("const bool showDesktopStartupOnboarding = !initialHubLoaded && !useEmbeddedStartupOnboarding;", app_main_text)
        self.assertIn("onboardingRouteBootstrapController.configure(useEmbeddedStartupOnboarding, initialHubLoaded);", app_main_text)
        ...
        self.assertIn("WhatSon::Android::Storage::isMountedHubPath(startupHubPath)", app_main_text)
        self.assertIn("WhatSon::Android::Storage::mountedHubSourceUri(startupHubPath);", app_main_text)
        self.assertIn("WhatSon::Android::Storage::mountHub(sourceUri, &remountedHubPath, &remountError)", app_main_text)
        ...
        self.assertIn("Q_PROPERTY(bool embeddedOnboardingVisible READ embeddedOnboardingVisible NOTIFY embeddedOnboardingVisibleChanged)",
                      route_bootstrap_header_text)
        self.assertIn("void configure(bool embeddedEnabled, bool startupHubLoaded);", route_bootstrap_header_text)
        ...
        self.assertIn("void OnboardingRouteBootstrapController::configure(const bool embeddedEnabled, const bool startupHubLoaded)",
                      route_bootstrap_impl_text)
