...
class CliOnboardingTests(unittest.TestCase):
    ...
    def test_app_supports_onboarding_only_launch_mode(self) -> None:
        ...
        self.assertIn("applicationWindow.onboardingHubController.beginWorkspaceTransition();", main_qml_text)
        self.assertIn("applicationWindow.onboardingRouteCommitPending = true;", main_qml_text)
        self.assertIn('applicationWindow.syncOnboardingRoute("embeddedHubLoaded");', main_qml_text)
        self.assertIn('applicationWindow.onboardingHubController.completeWorkspaceTransition();', main_qml_text)
        self.assertIn('applicationWindow.onboardingHubController.failWorkspaceTransition(', main_qml_text)
        self.assertIn('applicationWindow.syncOnboardingRoute("embeddedOperationFailed");', main_qml_text)
        self.assertIn('applicationWindow.syncOnboardingRoute("embeddedDismissed");', main_qml_text)
