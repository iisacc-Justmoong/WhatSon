...
class CliOnboardingTests(unittest.TestCase):
    ...
    def test_app_supports_onboarding_only_launch_mode(self) -> None:
        ...
        self.assertIn("const QByteArray startupHubAccessBookmark = selectedHubStore.selectedHubAccessBookmark();", app_main_text)
        self.assertIn("const auto resolveStartupHubMountPath =", app_main_text)
        self.assertIn("const QByteArray& hubAccessBookmark", app_main_text)
        self.assertIn("restoreAccessFromBookmarkData(", app_main_text)
