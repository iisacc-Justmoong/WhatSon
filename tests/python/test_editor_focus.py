...
class EditorFocusTests(unittest.TestCase):
    def test_new_note_creation_emits_focus_signal_and_editor_consumes_it(self) -> None:
        ...
        self.assertIn("property var libraryHierarchyViewModel: null", body_layout_text)
        self.assertIn("libraryHierarchyViewModel: hStack.libraryHierarchyViewModel", body_layout_text)
