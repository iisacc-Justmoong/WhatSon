...
- Geometry/minimap snapshot planning, viewport line math, input/context-menu shortcut orchestration, and the thin
  ...
  `src/app/models/editor/display/ContentsDisplaySelectionOrchestrationModel.qml`, and
  `src/app/models/editor/display/ContentsDisplayPresentationOrchestrationModel.qml`.
