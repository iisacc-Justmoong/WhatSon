...
- The left segment group is `drawerModes` (`155:4566`) and keeps four stable child ids:
  `quickNoteButton`, `itemBoxButton`, `dataSearchButton`, and `graphViewButton`.
- The right control group is `drawerViewConfig` (`155:4567`) and keeps `textAlignButton`, `viewOptionsButton`, and
