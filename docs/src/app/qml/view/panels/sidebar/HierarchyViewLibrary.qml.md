...
## Source Metadata
- Source path: `src/app/qml/view/panels/sidebar/HierarchyViewLibrary.qml`
- Source kind: QML view/component
- File name: `HierarchyViewLibrary.qml`
- Approximate line count: 19

## QML Surface Snapshot
- Root type: `SidebarHierarchyView`
...
- That contract currently exposes `New Folder` and `Delete Folder` and reuses the existing library hierarchy
  controller CRUD actions rather than introducing a library-specific menu controller.
