...
- Keeps hidden inline tag cursor normalization, visible-surface selection mapping, line/paragraph logical range
  selection, and atomic resource-block selection policy out of QML.
