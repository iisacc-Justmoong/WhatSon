...
- Inputs: `textItem`, `targetItem`, `visualItem`, explicit resource visual block heights, logical line ranges, and
  primitive visual geometry values supplied by the QML view layer.
