...
- Active hierarchy consumers that need a coherent "toolbar index + hierarchy controller + note-list model" tuple can now
...
- `hierarchyControllerForIndex(...)` and `noteListModelForIndex(...)` now also force
