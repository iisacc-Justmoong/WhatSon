...
- The controller still owns the normalized week anchor.
- The controller now also owns the lazy horizontal timeline window (`timelineDayModels`) and can initialize, prepend,
