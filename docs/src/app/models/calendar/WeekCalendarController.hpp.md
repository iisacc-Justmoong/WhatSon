...
## Role
`WeekCalendarController` exposes both the canonical 7-day week projection and the lazy horizontal timeline date window
...
- The controller now owns that scaffold's timeline-day model window through `timelineDayModels` plus incremental
