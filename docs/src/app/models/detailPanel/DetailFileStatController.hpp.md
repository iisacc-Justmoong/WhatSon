...
## Responsibility
`DetailFileStatController` is the dedicated detail-panel statistics object for the `fileStat` toolbar state.
...
## Lifecycle
- `applyHeader(...)` copies the currently loaded note header snapshot into the controller.
