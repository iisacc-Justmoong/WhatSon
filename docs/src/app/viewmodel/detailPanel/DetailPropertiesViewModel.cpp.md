# `src/app/viewmodel/detailPanel/DetailPropertiesViewModel.cpp`

## Responsibility
- Projects note-header metadata into the detail panel's properties section.
- Keeps folder/tag item lists plus the current project, bookmark, and progress values in one lightweight viewmodel.
