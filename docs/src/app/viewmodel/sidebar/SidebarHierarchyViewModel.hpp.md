...
- Richer consumers can now depend on the context-level interface to read the active hierarchy viewmodel and active
  note-list model without naming `SidebarHierarchyViewModel` directly.
