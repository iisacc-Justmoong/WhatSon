...
void WhatSonCppRegressionTests::mobileChrome_keepsRestoredShellWithEditorViewModeCombo()
{
    ...
    QVERIFY(mobileEventSurfaceSource.contains(QStringLiteral("property alias controller: mobileEventController")));
    ...
    QVERIFY(mobileEventSurfaceSource.contains(QStringLiteral("mobileEventController.beginTouchSequence")));
    QVERIFY(mobileEventSurfaceSource.contains(QStringLiteral("mobileEventController.updateTouchSequence")));
    QVERIFY(mobileEventSurfaceSource.contains(QStringLiteral("mobileEventController.endTouchSequence")));
    QVERIFY(mobileEventSurfaceSource.contains(QStringLiteral("mobileEventController.cancelTouchSequence")));
