...
void WhatSonCppRegressionTests::mobileChrome_keepsRestoredShellWithEditorViewModeCombo()
{
    ...
    QVERIFY(!mobileHierarchyPageSource.contains(QStringLiteral("clipboardEditorPaste")));
    QVERIFY(!mobileHierarchyPageSource.contains(QStringLiteral("editorInputCommandFilter")));
