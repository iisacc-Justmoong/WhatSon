...
void WhatSonCppRegressionTests::qmlContentsView_keepsOnlyGutterTextEditorMinimapViews()
{
    ...
    QVERIFY(textEditorSource.contains(QStringLiteral("property var documentModel: null")));
    QVERIFY(textEditorSource.contains(QStringLiteral("property var imeAdapter: null")));
    QVERIFY(textEditorSource.contains(QStringLiteral("readonly property string editorDocumentText")));
    QVERIFY(textEditorSource.contains(QStringLiteral("readonly property int cursorPosition")));
