...
void WhatSonCppRegressionTests::contentsLineNumberRailMetrics_ignoresExternalLogicalTextForResourceRows()
{
    ...
    QCOMPARE(ranges.at(1).toMap().value(QStringLiteral("sourceStart")).toInt(), resourceStart);
    QCOMPARE(ranges.at(1).toMap().value(QStringLiteral("sourceEnd")).toInt(), resourceEnd);
    QVERIFY(ranges.at(2).toMap().value(QStringLiteral("sourceStart")).toInt() > resourceEnd);
    QCOMPARE(ranges.at(2).toMap().value(QStringLiteral("number")).toInt(), 3);
}
...
void WhatSonCppRegressionTests::contentsEditorGeometryProvider_keepsTextRowsOnLogicalGeometry()
{
    QQmlEngine engine;
    const std::unique_ptr<QObject> textGeometry = createGeometryProbe(
        ...
        QVariantMap{
            ...
            {QStringLiteral("12"), QRectF(0.0, 36.0, 120.0, 18.0)},
            {QStringLiteral("17"), QRectF(0.0, 36.0, 120.0, 18.0)},
        });
    ...
    provider.setLineNumberRanges(QVariantList{
        ...
        QVariantMap{
            {QStringLiteral("logicalEnd"), 18},
            {QStringLiteral("logicalStart"), 12},
            {QStringLiteral("resourceRange"), false},
        },
    });
...
void WhatSonCppRegressionTests::contentsEditorGeometryProvider_anchorsRowsAfterResourceToFrameBottom()
{
    ...
    const std::unique_ptr<QObject> textGeometry = createGeometryProbe(
        ...
        QVariantMap{
            ...
            {QStringLiteral("1"), QRectF(0.0, 18.0, 120.0, 18.0)},
            {QStringLiteral("2"), QRectF(0.0, 0.0, 120.0, 18.0)},
            {QStringLiteral("5"), QRectF(0.0, 0.0, 120.0, 18.0)},
        });
    QVERIFY(textGeometry != nullptr);
...
void WhatSonCppRegressionTests::contentsEditorGeometryProvider_clampsProbeRowsInsideResourceFrame()
{
    QQmlEngine engine;
    const std::unique_ptr<QObject> textGeometry = createGeometryProbe(
        engine,
        ...
        QVariantMap{
            ...
            {QStringLiteral("2"), QRectF(0.0, 0.0, 120.0, 18.0)},
            {QStringLiteral("3"), QRectF(0.0, 0.0, 120.0, 18.0)},
            {QStringLiteral("4"), QRectF(0.0, 84.0, 120.0, 18.0)},
            {QStringLiteral("8"), QRectF(0.0, 84.0, 120.0, 18.0)},
        });
    QVERIFY(textGeometry != nullptr);
    ...
    provider.setLineNumberRanges(QVariantList{
        ...
        QVariantMap{
            {QStringLiteral("logicalEnd"), 4},
            {QStringLiteral("logicalStart"), 2},
            {QStringLiteral("resourceRange"), false},
        },
        QVariantMap{
            {QStringLiteral("logicalEnd"), 9},
            {QStringLiteral("logicalStart"), 4},
            {QStringLiteral("resourceRange"), false},
        },
    });
...
void WhatSonCppRegressionTests::contentsEditorGeometryProvider_offsetsRowsAfterStructuredResourceFrames()
{
    ...
    const std::unique_ptr<QObject> textGeometry = createGeometryProbe(
        ...
        QVariantMap{
            ...
            {QStringLiteral("4"), QRectF(0.0, 0.0, 120.0, 18.0)},
            {QStringLiteral("6"), QRectF(0.0, 18.0, 120.0, 18.0)},
            {QStringLiteral("8"), QRectF(0.0, 36.0, 120.0, 18.0)},
            {QStringLiteral("11"), QRectF(0.0, 36.0, 120.0, 18.0)},
            {QStringLiteral("13"), QRectF(0.0, 54.0, 120.0, 18.0)},
            {QStringLiteral("17"), QRectF(0.0, 54.0, 120.0, 18.0)},
        });
    QVERIFY(textGeometry != nullptr);
    ...
    provider.setLineNumberRanges(QVariantList{
        ...
        QVariantMap{
            {QStringLiteral("logicalEnd"), 7},
            {QStringLiteral("logicalStart"), 6},
            {QStringLiteral("resourceRange"), true},
        },
        QVariantMap{
            {QStringLiteral("logicalEnd"), 12},
            {QStringLiteral("logicalStart"), 8},
            {QStringLiteral("resourceRange"), false},
        },
        QVariantMap{
            {QStringLiteral("logicalEnd"), 18},
            {QStringLiteral("logicalStart"), 13},
            {QStringLiteral("resourceRange"), false},
        },
    });
    ...
    QCOMPARE(rows.at(0).toMap().value(QStringLiteral("y")).toDouble(), 0.0);
    QCOMPARE(rows.at(1).toMap().value(QStringLiteral("y")).toDouble(), 18.0);
    QCOMPARE(rows.at(1).toMap().value(QStringLiteral("height")).toDouble(), 114.0);
    QCOMPARE(rows.at(2).toMap().value(QStringLiteral("y")).toDouble(), 132.0);
    QCOMPARE(rows.at(3).toMap().value(QStringLiteral("y")).toDouble(), 150.0);
}
